...
The function `getFeat()` requires a set of phonemes `ph` and a language `lg`. It outputs the minimal matrix of distinctive features for `ph` given the phonemic inventory of `lg`. Five languages are supported: English, French, Italian, Portuguese, and Spanish. Here are some examples.
