...
<a href = "https://doi.org/10.5281/zenodo.7811254" target = "_blank"><img src = "https://zenodo.org/badge/DOI/10.5281/zenodo.7811254.svg" alt="DOI"></a>
</p>
...
- `stopwords_pt`, `stopwords_fr`, `stopwords_sp`, `stopwords_it`, and
  `stopwords_en` contain stopwords in Portuguese, French, Spanish,
  Italian, and English
...
real or not) in Portuguese, Spanish, French, Italian, or English in its
orthographic form and returns its phonemic (i.e., broad) transcription.
...
`ipa_fr_test()`, `ipa_sp_test()`, or `ipa_it_test()` for sample words in
