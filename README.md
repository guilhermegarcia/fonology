...
[Portuguese Stress Lexicon](psl.html) \[@garcia2014_corpus_new\]—if the
word is listed there. Second, **nonce** words follow the general
patterns of Portuguese stress *as well as* probabilistic tendencies
shown in my work \[@garcia_2017_thesis; @garcia_2017_phonology;
@garcia_2019_lg\]. As a result, a nonce word *may* have antepenultimate
...
such as @wetzels2007. Secondary stress is provided when `narrow = T`.
For `ipa_pt_vec()`, stress is *not* probabilistic (and therefore not
variable): it merely follows the orthography as well as the typical
